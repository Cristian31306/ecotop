  ...
  conn.sftp((err, sftp) => {
    ...
    sftp.writeFile('/home/cristian/ecotop_nginx.conf', nginxConfig, (err) => {
      ...
      const commands = [
        ...
        'echo "Cristian_5732988$" | sudo -S chown -R www-data:www-data /home/cristian/apps/ecotop/storage /home/cristian/apps/ecotop/bootstrap/cache /home/cristian/apps/ecotop/public/build /home/cristian/apps/ecotop/database',
        'echo "Cristian_5732988$" | sudo -S chmod -R 775 /home/cristian/apps/ecotop/storage /home/cristian/apps/ecotop/bootstrap/cache /home/cristian/apps/ecotop/public/build /home/cristian/apps/ecotop/database',
        ...
        'echo "=== Creating Backup of Production SQLite Database ==="',
        'cp /home/cristian/apps/ecotop/database/database.sqlite /home/cristian/apps/ecotop/database/database.sqlite.bak_desglose || echo "Backup failed"',
